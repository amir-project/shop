                        ...
                        <div class="column col-lg-2 col-md-3"><a href="category.html">{{$category->title}}</a>
                            <div>
                                <ul>
                                    ...
                                    <li><a href="category.html">{{$childCategory->title}} @if ($childCategory->children->count()>0)
                                    ...
                                    @endif</a>
                                        ...
                                        @if ($childCategory->children->count()>0)
                                            <div class="dropdown-menu">
                                                <ul>
                                                    @foreach ($childCategory->children as $subMenu)
                                                        <li><a href="category.html">{{$subMenu->title}}</a></li>
                                                    @endforeach
